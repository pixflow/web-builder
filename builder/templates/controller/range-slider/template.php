<div class='karma-range-slider-container'>
	...
	<div class="karma-range-slider-content">
		<input type="range" class="karma-range-slider-range" value="{{{data.value}}}" min="{{{data.options.min}}}" max="{{{data.options.max}}}">
		<div class="karma-range-slider-number">
			<input type="number" class="karma-range-slider-input" value="{{{data.value}}}" min="{{{data.options.min}}}" max="{{{data.options.max}}}">
