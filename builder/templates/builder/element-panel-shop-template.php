<div class="element-panel-section-container element-panel-shop element-panel-deactive-part" >
	...
	<div class="element-panel-part-title"><?php echo esc_attr__("Shop Premium", 'karma');?></div>
	<div class="element-panel-part-description"><?php echo esc_attr__("All you need to do your best work, together in one package that works seamlessly from your computer, phone or tablet.", 'karma');?>
	</div>
