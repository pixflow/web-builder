...
<div class="karma-fonts-list" >
	<div class="karma-font-list karma-font-manger-box-style">
		<div class="karma-font-name-part" >
			<span class="karma-font-name" style="font-family: 'HelveticaNeue';">Roboto</span>
			<span class="karma-font-weight-count" > 2 Styles
